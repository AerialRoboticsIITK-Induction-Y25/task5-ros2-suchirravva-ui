...
public:
    MissionDrone(const std::string& v_name, float initial_battery, float max_alt, float spd, const std::string& m_name);
    ...
    size_t get_total_waypoints() const { return waypoints.size(); }
};
